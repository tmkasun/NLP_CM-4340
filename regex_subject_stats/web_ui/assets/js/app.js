...
var locations = new Bloodhound({
    ...
    remote : {
        url : 'index.php/testing/geo_names?location=%QUERY',
...
function init_typeahead() {
    ...
    $('#locationSearchbox').typeahead({
        ...
        L.circle([coordinates[1],coordinates[0]],1000,{'fillColor': '#F00','stroke': false}).addTo(map);
        L.circle([coordinates[1],coordinates[0]],2000,{'fillColor': '#FF9100','stroke': false}).addTo(map);
